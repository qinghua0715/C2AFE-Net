...
from Models.networks.unet_v2.pvtv2 import *
...
class UNetV2(nn.Module):
    ...
    """
    def __init__(self, in_cha=3, n_classes=1, channel=32, deep_supervision=False, pretrained_path=None):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = UNetV2(3, n_classes=1, deep_supervision=False, pretrained_path=None)
