...
from Models.networks.DCSAU_net import splat
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 ...
                 norm_layer=None, dropblock_prob=0.0, last_gamma=False, number=1, custom=0):
...
class ResNet(nn.Module):
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64,
        ...
        self.layer7 = self._make_layer(block, ConvFea[0] // 2, layers[2], stride=1, norm_layer=norm_layer,
                                       inchannel=256)
        self.layer8 = self._make_layer(block, ConvFea[0] // 2, layers[3], norm_layer=norm_layer, is_first=False,
                                       inchannel=128)
