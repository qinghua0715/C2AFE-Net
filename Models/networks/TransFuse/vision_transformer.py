...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 2, 'input_size': (3, 512, 512), 'pool_size': None,
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=512, patch_size=16, in_chans=3, embed_dim=768):
        ...
        self.proj = nn.Conv2d(in_chans, embed_dim, kernel_size=patch_size, stride=patch_size)#不重叠的滑动窗口
...
class VisionTransformer(nn.Module):
    ...
    """
    def __init__(self, img_size=256, patch_size=16, in_chans=3, num_classes=1, embed_dim=768, depth=12,
        ...
        num_patches = self.patch_embed.num_patches#patch的数量
