...
class TransFuse_S(nn.Module):
    def __init__(self, in_cha, num_classes=1, drop_rate=0.2, normal_init=True, pretrained=False):
    ...
    def forward(self, imgs, labels=None):
        ...
        map_x = nn.Sigmoid()(map_x)
        map_1 = nn.Sigmoid()(map_1)
        map_2 = nn.Sigmoid()(map_2)
        return map_2
